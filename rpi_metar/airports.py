...
class Airport(object):
    ...
    def process_metar(self, metars):
        ...
        # Thunderstorms
        self.thunderstorms = any(word in metar['raw_text'] for word in ['TSRA', 'VCTS', 'THUNDERSTORMS', 'TSGR', 'TSRASN', 'DL-N', 'DL-NE', 'DL-E', 'DL-SE', 'DL-S', 'DL-SW', 'DL-W', 'DL-NW', 'HEAVY', ' TS ', 'DL-', 'LIGHTNING', 'DL-N/DL-NW', 'DL-S/DL-SW', 'DL-N/DL-NE', 'DL-S/DL-SE']) and self.category != wx.FlightCategory.OFF
